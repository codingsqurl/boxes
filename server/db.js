...
function initDb() {
  ...
  try { db.exec(`ALTER TABLE leads ADD COLUMN notify_attempts INTEGER NOT NULL DEFAULT 0`); } catch {}
  try { db.exec(`ALTER TABLE appointments ADD COLUMN notify_attempts INTEGER NOT NULL DEFAULT 0`); } catch {}
